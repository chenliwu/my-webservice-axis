 ...
 * @date 2020/09/30
 */
public class Axis2Tester2 {


    public static final String targetEndpoint = "http://192.168.1.7:9090/bfsServerWeb/services/BfsBankServer?wsdl";
    public static final String targetNamespace = "http://webservice.chenlw.com/";

    public static final String METHOD = "bfsBankServer";
